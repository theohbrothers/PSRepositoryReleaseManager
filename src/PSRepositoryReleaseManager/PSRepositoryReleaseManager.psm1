...
$script:MODULE['GENERATE_DIR'] = Join-Path $script:MODULE['BASE_DIR'] 'generate'      # Module generate functions
...
Get-ChildItem -Path "$($script:MODULE['GENERATE_DIR'])\*.ps1" | % { . $_.FullName }
